...
class Config:
    ...
    DEFAULT_CONFIG = {
        ...
        "audio_quality": {"sample_rate": 16000, "channels": 1, "convert_to_wav": True},
        "transcription": {
            "vad_filter": True,
        ...
        "output": {"directory": None, "filename_template": "{input_name}_transcript"},
    }
    ...
    def get_model_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "min_silence_duration_ms": self.get(
                "transcription.min_silence_duration_ms"
            ),
